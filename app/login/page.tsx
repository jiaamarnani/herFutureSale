  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ color: '#FF1866', fontWeight: 800, fontSize: '2.5rem', marginBottom: '2rem' }}>Member Login</h1>

        <div style={{ marginBottom: '1.5rem' }}>
          <label style={{ display: 'block', color: '#FF1866', fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Email</label>
          <input
            type="email"
            value={email}
        ...
        <div style={{ marginBottom: '2rem' }}>
          <label style={{ display: 'block', color: '#FF1866', fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Password</label>
          <input
            type="password"
            value={password}
